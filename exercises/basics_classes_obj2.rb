...
Using the following code, add two methods: ::generic_greeting and #personal_greeting. The first method should be a class method and print a 
greeting that's generic to the class. The second method should be an instance method and print a greeting that's custom to the object.
...
class Cat
  ...
  def self.generic_greeting
    puts "This is a generic greeting for cats."
  end

  def personal_greeting
    puts "This is a personal greeting for #{name}."
  end
end
